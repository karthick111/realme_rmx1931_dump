...
case "$enable" in
    "1")
        ...
        echo 1 > /sys/devices/system/cpu/cpu7/core_ctl/disable
        n=0
        while [ n -lt 3 ]; do
    ...
    "0")
        ...
        echo 710400 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
        echo 2419200 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq
        echo 825600 > /sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq
        echo 2841600 > /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq

        #enable core_ctl
        echo 0 > /sys/devices/system/cpu/cpu0/core_ctl/disable
        echo 0 > /sys/devices/system/cpu/cpu4/core_ctl/disable
        echo 0 > /sys/devices/system/cpu/cpu7/core_ctl/disable
        ;;
esac
#endif /* VENDOR_EDIT */
